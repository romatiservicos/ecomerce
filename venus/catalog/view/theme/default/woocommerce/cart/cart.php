...
<div class="row">
	<div class="col-xs-12 col-md-8">
		<div class="buttons-cart">
			...
			<a class="continue" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>"><?php _e('Continue Shopping', 'woocommerce');?></a>
		</div>
