    ...
    class Road_Theme_Config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'desc'      => __('General theme options<br><img src="http://www.themelock.com/ete.jpg">', 'redux-framework'),
                'icon'      => 'el-icon-cog',
                'fields'    => array(
					...
					array(
                        'id'        => 'logo_footer',
                        'type'      => 'media',
                        'title'     => __('Logo Footer', 'redux-framework'),
                        'compiler'  => 'true',
                        'mode'      => false,
                        'desc'      => __('Upload logo here.', 'redux-framework'),
                    ),
					...
					array(
						...
						'subtitle'     => __('Image for error 404 page', 'redux-framework'),
                        'compiler'  => 'true',
                        'mode'      => false,
                    ),
                ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        ...
                        'subtitle'  => __('Pick a color for primary color (default: #c38749).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#c38749',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for bg sale label (default: #c38749).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#c38749',
                        'validate'  => 'color',
                    ),
					...
					array(
                        ...
                        'subtitle'  => __('Pick a color for star of rating (default: #c38749).', 'redux-framework'),
						'transparent' => false,
                        'default'   => '#c38749',
                        'validate'  => 'color',
                    ),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'        => 'welcome_message',
                        'type'      => 'text',
                        'title'     => __('Welcome message', 'redux-framework'),
			...
			$this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        'id'        => 'product_tag_title',
                        'type'      => 'text',
                        'title'     => __('Product tag title', 'redux-framework'),
                        'default'   => 'Popular Tags'
                    ),
					array(
                        'id'        => 'twitter_widget_title',
                        'type'      => 'text',
                        'title'     => __('Twitter widget title', 'redux-framework'),
			...
			$this->sections[] = array(
				'icon'       => 'el-icon-website',
				'title'      => __( 'Products Shortcode', 'redux-framework' ),
				'subsection' => true,
				'fields'     => array(
					array(
                        'id'        => 'product_shortcode1_title',
                        'type'      => 'text',
                        'title'     => __('Product shortcode title #1', 'redux-framework'),
                        'default'   => 'Top rated'
                    ),
					array(
                        'id'        => 'product_shortcode1',
                        'type'      => 'text',
                        'title'     => __('Product shortcode #1', 'redux-framework'),
                        'default'   => '[top_rated_products per_page="2"]'
                    ),
					array(
                        'id'        => 'product_shortcode2_title',
                        'type'      => 'text',
                        'title'     => __('Product shortcode title #2', 'redux-framework'),
                        'default'   => 'best seller'
                    ),
					array(
                        'id'        => 'product_shortcode2',
                        'type'      => 'text',
                        'title'     => __('Product shortcode #2', 'redux-framework'),
                        'default'   => '[best_selling_products per_page="2"]'
                    ),
				)
			);
			...
			$this->sections[] = array(
                ...
                'desc'      => __('Upload brand logos and links - vv p l o c k e r . c o  m ', 'redux-framework'),
                'icon'      => 'el-icon-briefcase',
                'fields'    => array(
					array(
                        'id'        => 'brand_title',
                        'type'      => 'text',
                        'title'     => __('Brand title', 'redux-framework'),
                        'default'   => 'Our Brands'
                    ),
					array(
						'id'        => 'brandnumber',
						'type'      => 'slider',
						'title'     => __('Number of logos per page', 'redux-framework'),
						'desc'      => __('Number of logos per page, default value: 6', 'redux-framework'),
						"default"   => 6,
						"min"       => 1,
						"step"      => 1,
						"max"       => 12,
			...
			//Categories carousel
			$this->sections[] = array(
                'title'     => __('Categories carousel', 'redux-framework'),
                'desc'      => __('Upload category images and links', 'redux-framework'),
                'icon'      => 'el-icon-random',
                'fields'    => array(
					array(
						'id'        => 'catenumber',
						'type'      => 'slider',
						'title'     => __('Number of categories per page', 'redux-framework'),
						'desc'      => __('Number of categories per page, default value: 4', 'redux-framework'),
						"default"   => 4,
						"min"       => 1,
						"step"      => 1,
						"max"       => 8,
					...
					array(
						...
						'type'      => 'slider',
						'title'     => __('Scroll amount', 'redux-framework'),
						'desc'      => __('Number of categories to scroll one time, default value: 1', 'redux-framework'),
						"default"   => 1,
						"min"       => 1,
						"step"      => 1,
						"max"       => 4,
					...
					array(
						'id'          => 'cate_images',
						'type'        => 'slides',
						'title'       => __('Categories', 'redux-framework'),
						'desc'        => __('Upload image and enter category link.', 'redux-framework'),
						'placeholder' => array(
							'title'           => __('Title', 'redux-framework'),
							'description'     => __('Description', 'redux-framework'),
							'url'             => __('Link', 'redux-framework'),
