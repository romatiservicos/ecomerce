				...
				<div class="container"> 
					...
					<div class="row">
						<div class="col-xs-12 col-md-3">
							<?php if(isset($road_opt['welcome_message'])) { ?>
								<div class="welcome-message"><?php echo esc_html($road_opt['welcome_message']);?></div>
							<?php } ?>
						</div>
			...
			<div class="header">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-12 col-md-<?php if ( class_exists( 'WC_Widget_Cart' ) || class_exists('WC_Widget_Product_Search') ) { echo '7'; } else {echo '9';} ?>">
						...
						<?php if ( class_exists( 'WC_Widget_Cart' ) || class_exists('WC_Widget_Product_Search') ) { ?>
